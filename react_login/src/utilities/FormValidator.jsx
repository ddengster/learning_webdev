        ...
        keys.map((key) => {
            if ('isRequired' in key[1] && key[1].isRequired) {
                if (key[1].value.length === 0) {
                    ...
                    if ('minLength' in key[1] && FormValidator.minLength(key[1].value, key[1].minLength)) {
                        results.push({
            ...
            } else if ('minLength' in key[1] && FormValidator.minLength(key[1].value, key[1].minLength)) {
                results.push({
                    [key[0]]: [`The ${key[0]} must at least ${key[1].minLength} characters.`]
                });
            }
